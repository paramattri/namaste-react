  ...
  return (
    <div className="flex items-center justify-between shadow-md px-36">
      ...
      <ul className="flex items-center">
        <li className="mx-7 font-medium text-slate-700 hover:text-yellow-500">
        ...
        <li className="mx-7 font-medium text-slate-700 hover:text-yellow-500 relative">
          <Link to="/cart">
            <span className="absolute text-sm right-[-24px] top-[-12px] bg-yellow-500 text-white rounded-[20px] p-[2px] px-[10px]">
              {cartItems.length}
            </span>
            Cart
          </Link>
